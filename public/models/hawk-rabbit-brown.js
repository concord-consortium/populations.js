...
(function() {
  ...
  window.model = {
    ...
    run: function() {
      ...
      this.env = env;
      this.env.setBackground("images/environments/snow-2.png");
    ...
    _setupChartData: function(chartData) {
      ...
      return chartData.addRows([["Brown", 2, "color: #904f10"], ["Sandy", 5, "color: #f2b05e"], ["White", 14, "color: #c5c4c3"]]);
    },
    ...
    setupTimer: function() {
      ...
      return Events.addEventListener(Environment.EVENTS.RESET, (function(_this) {
        return function() {
          return _this.env.setBackground("images/environments/snow-2.png");
        };
      })(this));
    },
    changeBackground: function(n) {
      ...
      return this.env.setBackground("images/environments/snow-2.png");
    },
    ...
    preload: ["images/agents/rabbits/rabbit2.png", "images/agents/hawks/hawk.png", "images/environments/snow-2.png"]
  };
