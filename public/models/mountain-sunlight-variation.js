...
(function() {
  ...
  window.model = {
    ...
    _getSideIsExtinct: function() {
      var agent, eastAlive, j, len, ref, westAlive, x;
      eastAlive = false;
      westAlive = false;
      ref = this.env.agents;
    ...
    _atLeastTenPlantsHealthyOnBothSides: function() {
      var agent, eastHealthyCount, j, len, ref, westHealthyCount, x;
      eastHealthyCount = 0;
      westHealthyCount = 0;
      ref = this.env.agents;
      for (j = 0, len = ref.length; j < len; j++) {
