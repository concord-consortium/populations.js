          ...
          rules: [
            {
              ...
              useIf: function(agent) {
                return agent.get('glow') && agent.get('size') === 1;
              }
            }, {
              image: {
              ...
              useIf: function(agent) {
                return agent.get('glow') && agent.get('size') === 2;
              }
            }, {
              image: {
              ...
              useIf: function(agent) {
                return agent.get('glow') && agent.get('size') === 3;
              }
            }
          ]
        }, {
