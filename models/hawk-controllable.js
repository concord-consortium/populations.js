...
(function() {
  ...
  window.model = {
    ...
    setupEnvironment: function() {
      var color, i, plant, rabbit, _i, _j, _k, _len, _ref, _ref1, _ref2;
      for (i = _i = 1, _ref = this.startingPlants; 1 <= _ref ? _i <= _ref : _i >= _ref; i = 1 <= _ref ? ++_i : --_i) {
      ...
      for (_j = 0, _len = _ref1.length; _j < _len; _j++) {
        color = _ref1[_j];
        for (i = _k = 1, _ref2 = this.startingRabbits; 1 <= _ref2 ? _k <= _ref2 : _k >= _ref2; i = 1 <= _ref2 ? ++_k : --_k) {
    ...
    setupControls: function() {
      ...
      return Events.addEventListener(Environment.EVENTS.AGENT_EATEN, function(evt) {
