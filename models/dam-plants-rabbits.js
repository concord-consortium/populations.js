...
(function() {
  ...
  window.model = {
    ...
    setupControls: function() {
      ...
      createDamButton.onclick = function() {
        if (!_this.damCreated) {
      ...
      noneHighlightRadio.onclick = function() {
        return _this._highlight(-1);
      };
      smallHighlightRadio.onclick = function() {
        return _this._highlight(1);
      };
      mediumHighlightRadio.onclick = function() {
        return _this._highlight(2);
      };
      bigHighlightRadio.onclick = function() {
