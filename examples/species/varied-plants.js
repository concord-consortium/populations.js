...
window.VariedPlantsSpecies = new Populations.Species({
  ...
  traits: [
    new Populations.Trait({name: "size", min: 1, max: 10, mutatable: true}),
    new Populations.Trait({name: "root size",min: 1, max: 10, mutatable: true})
  ],
  imageRules: [
    {
      name: 'plant',
